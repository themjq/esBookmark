<template>
  <div class="app-container">
    ...
    <!--搜索表单-->
    <el-form :inline="true" :model="searchAdmin" class="demo-form-inline">
      ...
      <el-form-item label="性别">
        <el-select v-model="searchAdmin.sex" placeholder="请选择">
    ...
    <el-row>
      ...
      <el-button type="primary" size="medium" @click="dialogVisible = true;admin = { avatar: ''};" >+ 新增</el-button>
    </el-row>
    ...
    <el-dialog ref="form" title="编辑用户" :visible.sync="dialogVisible" width="30%">
      <el-form ref="form" :model="admin" label-width="80px" size="mini">
        ...
        <el-form-item label="性别" >
          <el-select v-model="admin.sex" placeholder="请选择" style="width:100%" >
             <el-option
        ...
        <el-form-item label="状态">
          <el-select v-model="admin.status" placeholder="请选择" value-key="admin.status" style="width:100%">
            <el-option
